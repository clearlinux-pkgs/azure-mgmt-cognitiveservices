...
Source0  : https://files.pythonhosted.org/packages/a2/b2/209015559d399f3a9b67ee2faaf7b19676e2f15107a1b20f99a5a3d1a82c/azure-mgmt-cognitiveservices-6.3.0.zip
Summary  : Microsoft Azure Cognitive Services Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-cognitiveservices-python = %{version}-%{release}
Requires: azure-mgmt-cognitiveservices-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-cognitiveservices package.
Group: Default
Requires: azure-mgmt-cognitiveservices-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-cognitiveservices package.


%package python3
Summary: python3 components for the azure-mgmt-cognitiveservices package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_cognitiveservices)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-cognitiveservices package.


%prep
%setup -q -n azure-mgmt-cognitiveservices-6.3.0
cd %{_builddir}/azure-mgmt-cognitiveservices-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608045786
